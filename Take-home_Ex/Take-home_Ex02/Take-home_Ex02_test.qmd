...
#| code-fold: true
#| code-summary: "Show the code"
math <- ggplot(stu_df, aes(x = factor(Gender), y = Math_Average, fill = factor(Gender))) +
 geom_violin(trim = FALSE) +
  ...
  labs(title = "Violin Plot with Box Plot and Labels for Math Score",
       ...
       x = "Gender",
       y = "Math Score") +
  scale_fill_manual(values = c("1" = "khaki3", "2" = "slategray3"), name = "Gender", labels = c("1" = "Female", "2" = "Male"))+
...
read <- ggplot(stu_df, aes(x = factor(Gender), y = Reading_Average, fill = factor(Gender))) +
 geom_violin(trim = FALSE) +
  geom_boxplot(width = 0.2, position = position_dodge(width = 0.75)) +
  stat_summary(
    fun = median,
...
science <- ggplot(stu_df, aes(x = factor(Gender), y = Science_Average, fill = factor(Gender))) +
 geom_violin(trim = FALSE) +
  geom_boxplot(width = 0.2, position = position_dodge(width = 0.75)) +
  stat_summary(
    fun = median,
...
avg <- ggplot(stu_df, aes(x = factor(Gender), y = Average_Score, fill = factor(Gender))) +
 geom_violin(trim = FALSE) +
  geom_boxplot(width = 0.2, position = position_dodge(width = 0.75)) +
  stat_summary(
    fun = median,
